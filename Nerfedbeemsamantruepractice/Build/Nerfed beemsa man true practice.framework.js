...
var ASM_CONSTS = {
  4412344: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4412399: ($0) => { performance.now = function() { return $0; }; },  
 4412447: ($0) => { performance.now = function() { return $0; }; },  
 4412495: () => { performance.now = Module['emscripten_get_now_backup']; }
};
